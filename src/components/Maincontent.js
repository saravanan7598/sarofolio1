    ...
    <>
          <div className='content-container' >
                  <div className='about-us'>
                        ...
                        <p><span>Hello I`m Saravanan.</span> I am first year student. I am pursing my bachelor degree at SKCET. I studied front-end technology in Youtube. My technical skill are good.I create many project in HTML, CSS, Js and ReactJs project like Youtube Clone etc. My project is my github id.</p>          
                        <hr className='hr'></hr>
                  </div>
                
                  <div className='skills overlay ' >
                      <div className='technical-skills' >
                       <h1>Technical Skills <hr></hr></h1>
                       ...
                       <div className='professional'>
                            <h1>Professional Skills<hr></hr></h1>
